...
(3, '2019_07_09_142102_create_categories_table', 1),
(4, '2019_08_19_000000_create_failed_jobs_table', 1),
(5, '2020_07_09_141842_create_events_table', 1),
(6, '2020_07_10_012233_create_event_users_table', 1);
...
--
ALTER TABLE `events`
  ADD CONSTRAINT `events_cat_id_foreign` FOREIGN KEY (`cat_id`) REFERENCES `categories` (`id`);
